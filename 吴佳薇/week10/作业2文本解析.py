...
messages = [
    {
        ...
        "content": [
            {
                "type": "image",
                "image": "https://pic2.zhimg.com/v2-d628d6e2099508d9afa0dfd9ba2fc594_r.jpg?source=172ae18b",
            },
            {"type": "text", "text": "extract the content from the image"},
        ],
    }
]
...
text 的内容可能是：
"<|im_start|>user\n<|image|>\nextract the content from the image<|im_end|>\n<|im_start|>assistant\n"
'''
