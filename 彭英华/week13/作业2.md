...
| /v1/chat/list | **POST** | user_name(str) | code(int),message(str)，session_id(str)<br>user_id(int),title(str),start_time(datetime)| 列举出用户对应的会话信息 |
| /v1/chat/feedback | **POST** | session_id(str),message_id(int),feed_back(bool) | code(int),message(str)，session_id(str)| 修改某次会话的某条信息的反馈 |
